...
static enum MHD_Result serve_html(struct MHD_Connection *connection)
{
	const char *page = "<!DOCTYPE html>"
					   ...
					   "<button onclick=\"fetch('/1')\">Power: PC 1</button>"
					   "<button onclick=\"fetch('/long_1')\">Long Power: PC 1</button>"
					   "<button onclick=\"fetch('/2')\">Power: PC 2</button>"
					   "<button onclick=\"fetch('/long_2')\">Long Power: PC 2</button>"
					   "<button onclick=\"fetch('/3')\">Power: PC 3</button>"
					   "<button onclick=\"fetch('/long_3')\">Long Power: PC 3</button>"
					   "</div>"
					   "</body>"
					   "</html>";
